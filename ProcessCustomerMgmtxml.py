...
def customermgmt_convert():
    with open('/Users/nishantsushmakar/Documents/projects_ulb/tpcdi-citus/data/scale_5/Batch1/CustomerMgmt.xml') as fd:
        doc = xmltodict.parse(fd.read()) 
        fd.close()

    with open("/Users/nishantsushmakar/Documents/projects_ulb/tpcdi-citus/data/scale_5/Batch1/CustomerData.json", "w") as outfile:
        outfile.write(json.dumps(doc))
        outfile.close()

    f = open('/Users/nishantsushmakar/Documents/projects_ulb/tpcdi-citus/data/scale_5/Batch1/CustomerData.json','r')
    ...
    cust_df.to_csv('/Users/nishantsushmakar/Documents/projects_ulb/tpcdi-citus/CustomerMgmt.csv', index = False)
